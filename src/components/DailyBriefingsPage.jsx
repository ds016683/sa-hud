...
const TODAY_CALLS = [
  {
    ...
    bullets: [
      'Core problem: regions see data 3 months after runs â€” field loses confidence from gaps (e.g., Mass General missing)',
      'Solution 1: Hospital-first coverage report queryable by region â€” shows network-to-NPI relationships, MRF quality, coverage %',
      'Solution 2: Interim reporting gates during post-processing â€” "here\'s what we\'re seeing so far" rather than end-of-run reveal',
      'Solution 3: Quarterly region leads call with David + Tanner + Peter to reset expectations and bring regions on the journey',
      'Alex Meyer proposed for 1099 hospital directory cleanup â€” ~40-50 hrs/week, 4-8 week engagement',
  ...
  },
  {
    ...
    bullets: [
      ...
      'APR-DRG conversion: pencils down â€” no viable public grouper, 3M licensing not viable, manage expectations with MMA',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Concern noted: Alex slow to respond despite being unemployed and actively looking â€” key thing to gauge',
      ...
      '~30-40% of files kicked out due to schema problems or payer name field errors â€” needs dedicated resource',
  ...
  },
  {
    ...
    bullets: [
      'Security hire: engineer (not CIO) â€” real need is security, DB management, user mgmt, API tracking; start fractional, FTE by year end',
      'OpenClaw defined as internal productivity tool only â€” not client-facing at this stage',
      ...
      'Recording disclosure policy needed before broader Granola adoption â€” unlike Zoom, passive tools give no notice',
  ...
  },
  {
    ...
    bullets: [
      ...
      'PREVENT calculator: replaces ASCVD/Framingham, calculates 10-year AND 30-year risk + heart age â€” flagged as key integration point',
      'Dyslipidemia guideline drove 10x traffic to PREVENT calculator in 10 days after publication',
      'AHA moving to modular, annually-updatable guidelines ("knowledge chunks") â€” platform could automate dissemination',
  ...
  },
  {
    ...
    bullets: [
      'Core issue: ~50% of Handle rates hitting Medicare floor (175% surgery/imaging, 225% hospitals) â€” Handle layered fallback logic on Arc',
      ...
      'Motive leaning toward option 2 + V9 as the path â€” pending internal discussion',
      'Episode-based pricing using PACES (988 defined episodes) + Komodo claims flagged as strong future direction',
      'Motive infrastructure: BigQuery â€” well-suited for Vertex AI semantic layer + natural language member search',
...
Today is a heavy production day â€” 6 calls starting at 11 AM. The day is MMA-focused through early afternoon, building toward the AHA demo with Juliana Crawford at 3:30 PM CT (the one that matters most), and closing with Trent at Motive at 5 PM.

Key priorities going in: MMA â€” Alex Meyer 1099 confirmation is your most important action item today, get it done. The reporting gates strategy also needs to land cleanly on the production call. AHA â€” lead with the PREVENT calculator integration angle, Juliana flagged it as the entry point. Let her drive the follow-up. Motive â€” Trent needs a clear decision on V8 bridge vs. V9; come in with a recommendation.
          ...
          <div style={{ marginBottom: 14 }}>
            ...
            {call.bullets.map((b, i) => (
              <div key={i} style={{ display: 'flex', gap: 8, marginBottom: 5 }}>
                <span style={{ color: '#C8102E', fontWeight: 700, flexShrink: 0, fontSize: 13 }}>â€¢</span>
