...
const AGENTS = [
  ...
  { id: 'mr-hc-analytics', emoji: '📊', name: 'Mr. HC Analytics', role: 'Healthcare analytics tutor', model: 'anthropic/claude-sonnet-4-6', channel: '#mr-hc-analytics', channelId: '1494477255592640764', status: 'active', color: '#059669', description: 'Healthcare analytics tutor. Teaches claims analysis, episode grouping, cost benchmarking, and network optimization using BigQuery as a hands-on sandbox.', capabilities: ['healthcare analytics', 'BigQuery exercises', 'claims analysis', 'episode grouping', 'cost benchmarking', 'curriculum management'], rules: 'Patient and domain-expert. Builds from David\'s Starset Analytics intuition to technical mastery. Coordinates with Mr. BigQuery for hands-on data exercises.' },
  { id: 'mr-cfa', emoji: '💰', name: 'Mr. CFA', role: 'CFA Level 1 exam prep', model: 'anthropic/claude-sonnet-4-6', channel: '#mr-cfa', channelId: '1494477296277655684', status: 'active', color: '#0D9488', description: 'CFA Level 1 exam preparation tutor. Structured curriculum, formula drilling, practice problems in exam format, and time management coaching.', capabilities: ['CFA curriculum', 'practice problems', 'formula drilling', 'mock exams', 'progress tracking'], rules: 'Structured and exam-focused. CFA L1 is breadth not depth. Focus on high-weight topics: FSA, Ethics, Fixed Income. 90 seconds per question target.' },
  { id: 'mr-math', emoji: '🧮', name: 'Mr. Math', role: 'Mathematics tutor', model: 'anthropic/claude-sonnet-4-6', channel: '#mr-math', channelId: '1494477327285882900', status: 'active', color: '#7C3AED', description: 'Self-paced mathematics tutor. Starting with Intermediate Algebra, progressing toward Calculus and Statistics. Follows textbook sequence with assigned problem sets.', capabilities: ['math instruction', 'problem sets', 'worked examples', 'textbook progression', 'foundation building'], rules: 'Rigorous about foundations. If David gets a concept wrong, don\'t move on until it clicks. Show worked examples step by step. Increase difficulty within each section.' },
  { id: 'mr-llm', emoji: '🤖', name: 'Mr. LLM', role: 'AI/ML development tutor', model: 'anthropic/claude-sonnet-4-6', channel: '#mr-llm', channelId: '1494477388677906594', status: 'active', color: '#EC4899', description: 'AI/ML development tutor. Project-based learning using David\'s own infrastructure (OpenClaw, Hermes, BigQuery, Mac M5). Builds real things to learn concepts.', capabilities: ['LLM APIs', 'prompt engineering', 'RAG', 'agent frameworks', 'fine-tuning', 'model deployment'], rules: 'Project-based and practical. Teaches by building real things on David\'s infrastructure. Coordinates with Mr. Build for implementation.' },
...
function AgentOrgChart() {
  ...
  const AGENT_CATEGORIES = [
    ...
    { label: 'Learning', color: '#0D9488', ids: ['mr-hc-analytics', 'mr-cfa', 'mr-math', 'mr-llm'] },
  ]
